...
public class GameViewController {
    ...
    private Queue<Player> players; // a queue of players

    @FXML
    private GridPane gameGrid; // THE GUI grid
    @FXML
    private Label p1Score; // player 1's score
    @FXML
    private Label p2Score; // Player 2's score
    @FXML
     ...
     *
     * @param p the pane where the circle resides
     */
